...
/**
 * This class represents the bounded context identifier. It should be used everywhere, when the
...
public class BoundedContextId {
  ...
  private static final FormatChecker CONTEXT_NAME_PATTERN_CHECKER =
      FormatChecker.createFor(PATTERN, WrongBoundedContextIdFormatException::new);
  ...
  private static final void checkThatBoundedContextIdIsNotReservedValue(
