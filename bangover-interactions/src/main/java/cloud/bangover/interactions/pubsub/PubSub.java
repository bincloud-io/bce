...
/**
 * This interface declares the contract of the pub-sub pattern implementation. This pattern works by
 * the fire and forget communication mechanism. This consists of three primary abstractions -
 * publisher, subscriber and topic. Publisher is the component which puts message to the topic
 * asynchronously and forget about that. In other words publisher doesn't wait response from any
