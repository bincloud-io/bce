...
class RulesSpec extends Specification {
  ...
  def "Scenario: passed rules checks"() {
    ...
    new RuleExecutor(Optional.of(new Object()), {Rules.isPresent(FAIL_MESSAGE_TEMPLATE)})                 | _
    new RuleExecutor(Optional.empty(), {Rules.isMissing(FAIL_MESSAGE_TEMPLATE)})                          | _
