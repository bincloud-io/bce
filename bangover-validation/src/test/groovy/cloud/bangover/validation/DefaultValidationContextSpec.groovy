...
class DefaultValidationContextSpec extends Specification {
  ...
  def "Scenario: validate internal validatable subobjects"() {
    ...
    GroupedErrors.errorsOf(DERIVED_COLLECTION_ITEM_UNGROUPED_ERRORS_GROUP_NAME, errorState).containsAll([MESSAGE_TEMPLATE_9])
    GroupedErrors.errorsOf(DERIVED_COLLECTION_ITEM_GROUPED_ERRORS_GROUP_NAME, errorState).containsAll([MESSAGE_TEMPLATE_10])
  }
